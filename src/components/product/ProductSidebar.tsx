...
const ProductSidebar: React.FC = () => {
  return (
    <div className=" border-[0.5px] border-t-4 border-t-[#37bee3]  border-gray-200">
      <div className="space-y-6 w-full">
        {/* Service Info */}
        <div className="p-6 space-y-4 border-b border-gray-200 pb-4">
        ...
        <div className="bg-[#0282a5] text-white px-4 py-3 text-center">
          <div className="justify-center gap-2">
            <span className="text-lg bg-white mr-5 w-10 border-2 p-1 rounded-full ">
              <PhoneFilled style={{ color: "#0282a5", fontSize: "20px" }} />
            </span>
            <span className="font-bold">Hotline: 1900 6750</span>
          </div>
        </div>
      </div>
    </div>
